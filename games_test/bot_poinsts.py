...
@bot.message_handler(func=lambda message: message.text.lower() in game_choices)
def handle_choice(message):
    global user_points, bot_points
    
    bot_choice = choice(game_choices)
    ...
    bot.send_message(message.chat.id, f'Текущий счёт:\nТвои очки: {user_points}\nОчки бота: {bot_points}')
